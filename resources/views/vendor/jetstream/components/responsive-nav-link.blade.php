...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-green-400 text-base font-medium text-green-800 bg-green-50 focus:outline-none focus:text-green-900 focus:bg-green-100 focus:border-green-700 transition'
